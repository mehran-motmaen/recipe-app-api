...
def sample_user(email='motmaen73@gmail.com', password='testest'):
...
class ModelTest(TestCase):
    ...
    def test_recipe_str(self):
        ...
        recipe = models.Recipe.objects.create(user=sample_user(), title='Steak and mushroom sauce', time_minutes=5,
                                              price=5.00)

        self.assertEqual(str(recipe), recipe.title)

    @patch('uuid.uuid4')
    def tset_recipe_file_name_uuid(self, mock_uuid):
